...
public class Operation implements NumericalValue {
    ...
    public Operation(String raw) {
        ...
        for (int i = 0; i < raw.length(); i++) {
            ...
            if (ch == '(') {
                ConsoleHandler.getInstance().info("Found opening parentheses.");
        ...
        ConsoleHandler.getInstance().info("Components in operation " + TextColor.LIGHT_PURPLE + this.getRawString() + ":");
        this.printComponents();
        ConsoleHandler.getInstance().info("Re-evaluated string: " + TextColor.LIGHT_PURPLE + this.getEvaluatedString());
    }
    ...
    private void printComponents() {
        for (Component component : this.getComponents()) ConsoleHandler.getInstance().info("  - " + component.getComponentType() + ": " + TextColor.LIGHT_PURPLE + component.getRawString());
    }
